	...
	<%@ include file="menu.jsp" %>
		...
		<div class="span24">
			<div class="step step1">
				...
				<table>
					...
					<tr>
						...
						<tr>
							...
							<td>
								<a href="${ pageContext.request.contextPath }/removeCart.action?pid=${cartItem.product.pid}" class="delete">删除</a>
							</td>
						</tr>
						</c:forEach>
					</tbody>
				...
				<div class="bottom">
					<a href="${ pageContext.request.contextPath }/clearCart.action" id="clear" class="clear">清空购物车</a>
